...
urlpatterns = [
     ...
     path('login/reviews', views.create_review, name='create_review'),
     path('register/reviews', views.create_review, name='create_review'),
     path('login/reviews_list.html', views.reviews_list, name='reviews_list'),
     path('register/reviews_list.html', views.reviews_list, name='reviews_list'),
    ]
