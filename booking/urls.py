...
urlpatterns = [
     ...
     path('register/create_review.html', views.reviews_list, name='reviews_list'),
     path('login/create_review.html', views.reviews_list, name='reviews_list'),
     path('reviews/', views.reviews_list, name='reviews_list'),
     path('reviews/edit/<int:review_id>', views.edit_review, name='edit_review'), 
     path('reviews/delete/<int:review_id>', views.delete_review, name='delete_review'),
     path('reviews/create_review.html', views.create_review, name='create_review'),
     path('create_review.html', views.create_review, name='create_review'),
     path('reviews/delete/index.html', views.delete_review, name='delete_review'),
     path('reviews/delete/info.html', views.info, name='delete_review'),
     path('reviews/delete/booking.hmtl', views.delete_review, name='delete_review'),
     path('reviews/delete/menu-starters.html', views.delete_review, name='delete_review'),
     path('reviews/delete/menu-main.html', views.delete_review, name='delete_review'),
     path('reviews/delete/menu-desserts.html', views.delete_review, name='delete_review'),
    ]
